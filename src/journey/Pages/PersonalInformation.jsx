...
export default function PersonalInformation() {
  ...
  const submit = async (e) => {
    ...
    const param = {
      ...
      personalEmail: mailid,
      spouseName: spousename || null,
      spouseMobile: spousecontact || null,
      residenceLandmark: landmark,
      workMode: workingMode,
      officialEmail: officialEmail,
      referenceMobile: referenceNumber || null,
      referenceName: referenceName || null,
      referenceRelationship: parseInt(referenceRelation) || null,
    };

    try {

      const response = await getPersonalDetail(param);
      console.log("personal detail response--", response, response?.data?.apiStatus);
      if (response?.data?.apiStatus === 1) {
        toast.success(response?.data?.message);
        window.clevertap?.event.push("lje_personal_details", {
            ...
            <div className='row'>
              <div className='col-lg-6 mt-3'>
                ...
                <div className="input-group mb-3">
                  <span className="input-group-text rounded-0"><EmailIcon style={{ color: '#9a141a' }} /></span>
                  <input
                    type="email"
                    value={mailid}
                    onChange={(e) => setmailId(e.target.value)}
                    placeholder='Personal Mail ID'
                    className="form-control h-45 rounded-0"
                  />
                </div>
                  ...
                  <div className='row'>
                    ...
                    <div className='col-lg-6 pt-3'>
                      ...
                      <div className="input-group">
                        <span className="input-group-text rounded-0"> <CallIcon style={{ color: '#9a141a' }} /></span>
                        <input
                          type="text"
                          value={spousecontact}
                          onChange={(e) => {
