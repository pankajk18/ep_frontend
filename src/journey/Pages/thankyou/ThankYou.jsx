...
function ThankYou() {
  ...
  useEffect(() => {
    ...
    imgLead.src =
      "https://www.facebook.com/tr?id=910056785411046&ev=SubmitApplication";
        ...
        <div className="bg-thanks">
          {applicationMode != "auto" && (
            <div className="thanks-left text-center">
              <div className="thanksmobile">
                <img
                  src={congratulationsMobile}
                  alt="Thank you for showing interest"
                />
              </div>
              <h1 className="fw-bold fs-2">
                Thank you for showing interest in{" "}
                <span style={{ color: "#1973be" }}>EmergencyPaisa</span>
              </h1>
              <h6 className="pt-4">
              ...
              {customerDetails?.show_ekyc_btn_flag === 0 && (
                <button
                  variant="outlined"
                  className="icon-color-primary mt-4 fs-5 py-4 px-3 ms-bg-secondary"
                  style={{ borderRadius: "10px", border: "0" }}
                  startIcon={<LibraryAddCheckIcon />}
                >
                  <Link
                    to="/journey/dashboard"
                    className="text-decoration-none icon-color-primary  text-white ms-bg-secondary py-4 px-3 "
                  >
                    {" "}
                    Go to Dashboard{" "}
                  </Link>
          ...
          {applicationMode == "auto" && (
            <div className="thanks-left text-center">
              ...
              <h6 className="pt-4">
                Your loan disbursal is currently in process and should be
                credited within <span className="fw-bold">15 minutes</span>.
                <br /> <br />
                If there is any delay, please contact us at:
                <div className="pt-4 fw-semibold fs-5 text-center">
                  <div>
                    <MailOutlineOutlinedIcon style={{ color: "#9a141a" }} />{" "}
                    help@emergencypaisa.com
                  </div>
                  <div className="pt-3">
                    <CallOutlinedIcon style={{ color: "#9a141a" }} />
                    <Link
