...
export default function LoanonAadhaarList() {
    ...
    useEffect(() => {
        const fetchServiceAreas = async () => {
            try {
                setLoading(true)
                const res = await fetch('https://api.crmpaisa.com/get-byaadhar-data')
                    ...
                    <div className='row  align-items-center'>
                        <div className='col-lg-12 text-center'>
                            <div className='ms-banner-heading'>
                                <span className='ms-takeaways ms-bg-secondary'> Aadhaar Card</span>
                                <h1 className='fs-2 pt-3 fw-semibold'>Get loan on your aadhar card</h1>
                            </div>
                        </div>
                    ...
                    <div className="row g-4 py-4 ">
                        {data.map((amtList) => (
                            <div key={amtList.byamount_id} className="col-lg-3 col-md-6 col-sm-12">
                                <Link to={`/aadhaar/${amtList.slug}`} className='text-decoration-none text-black'>
                                    <div className="loan-card d-flex align-items-center gap-3 p-3">
                                        ...
                                        <div>
                                            {/* <h5 className="fw-bold mb-1">{amtList.byamountName.split(" ")[0]}</h5> */}
