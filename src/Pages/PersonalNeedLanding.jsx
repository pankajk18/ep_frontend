...
export default function PersonalNeedLanding() {
  ...
  useEffect(() => {
    if (!slug) return;
    setLoading(true);
    fetch(`https://api.crmpaisa.com/get-bypersonalneed-data/${slug}`)
      .then((res) => {
        if (!res.ok) {
          ...
          <div className="row align-items-center text-center">
            <div className="col-lg-12">
              <div className="ms-banner-heading pt-4 pb-4">
                <span className="ms-takeaways ms-bg-secondary">
                  {" "}
                  Personal Need
                </span>
                <h1 className="fs-2 pt-3 fw-semibold">
                  Get loan on your Personal Need{" "}
                </h1>
              </div>
            </div>
          </div>
            ...
            <>
              <div className="container py-5">
                <div className="row align-items-center g-5">
                  <div className="col-lg-7 pt-5 pb-3">
                    ...
                    <p
                      className="fw-medium mb-3 opacity-75"
                      style={{ lineHeight: "28px" }}
                      dangerouslySetInnerHTML={{ __html: item.description }}
                    ></p>
                    <Link
                      to="https://emergencypaisa.com/apply-now?utm_source=seo&utm_medium=Web&utm_campaign=personalneedpages"
                      target="_blank"
                    >
              ...
              <div className="container py-5">
                <p
                  className="fw-medium mb-3 opacity-75"
                  style={{ lineHeight: "28px" }}
                  dangerouslySetInnerHTML={{ __html: item.extradescription }}
                ></p>
              </div>
              <CTAApplyNow />
              ...
              <RateandInterest />
              <div
                className="p-5 rounded-4 shadow-lg pb-0 pt-0 mb-5 "
