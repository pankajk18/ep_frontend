        ...
        <>
                ...
                <div className='row'>
                    <div className='col-lg-6 ms-left-wrap' >
                        ...
                        <div className='p-4'>
                            ...
                            <h5 className='fw-bolder ms-text-secondary'>Why EmergencyPaisa?</h5>
                            <ul className='pt-3'>
                                <li> <LibraryAddCheckIcon className='ms-text-primary' />  Quick online application</li>
                                <li> <LibraryAddCheckIcon className='ms-text-primary' />  Instant approval </li>
                                <li> <LibraryAddCheckIcon className='ms-text-primary' />  No collateral required</li>
                                <li> <LibraryAddCheckIcon className='ms-text-primary' />  Direct bank transfer</li>
                                <li> <LibraryAddCheckIcon className='ms-text-primary' />  Safe & transparent process</li>
                                <li> <LibraryAddCheckIcon className='ms-text-primary' />  Apply now and get funds when you need them most</li>
                            </ul>
                            <div className="d-flex justify-content-start align-items-center gap-3">
                                ...
                                <div className='text-center'>
                                    ...
                                    <div className="d-flex gap-3 mt-4">
                                        <Link to="https://play.google.com/store/apps/details?id=com.suburban.emergency_paisa" target="_blank" className="btn btn-dark d-flex align-items-center px-3">
                    ...
                    <div className='col-lg-6 ms-right-wrap'>
                        ...
                        <div className='ms-login-wrap pt-5'>
                            <h1 className='text-uppercase fw-bold fs-2'>Welcome To <span className='ms-text-secondary'>EmergencyPaisa</span></h1>
                            {phone}
                            {!otpInput ?
                                <>
                                    ...
                                    <div className='pt-3'>
                                        <div className="form-check">
                                            ...
                                            <span className="form-check-label fs-6" htmlFor="flexCheckIndeterminate">
                                                I agree to the <Link to='/terms-and-conditions' className='text-decoration-none fw-semibold ms-text-secondary'>Terms & Conditions</Link> and <Link to='/privacy-policy' className='text-decoration-none fw-semibold ms-text-secondary'>Privacy Policy</Link>.
                                            </span>
                                        </div>

                                        <div className="form-check">
                                            <input className="form-check-input" type="checkbox" checked={ischk2} onChange={handleTerm2} />
                                            <span className="form-check-label fs-6" htmlFor="flexCheckIndeterminate">
                                                I agree to receive Messages, Emails, RCS, SMS, Calls, and WhatsApp communications, along with updates to my mobile number or email.
                                            </span>
                                        </div>
                                    </div>
                                    <button
            ...
            <section className="py-5">
                <div className="container">
                    <div className="mb-5">
                        <h3 className="fw-bold ms-text-primary"> <span className='ms-text-secondary'>Interest Rates</span> & Charges</h3>
                        <p className="text-muted mt-2">
                            Welcome to the EmergencyPaisa website, operated by SUBURBAN FINANCE & INVESTMENT PRIVATE LIMITED
                            ("we", "us", "our"). By accessing or using our website ("Site") and services
                    ...
                    <div className="row">
                        <div className="col-md-6 col-lg-4 py-3 border-end border-bottom">
                            ...
                            <p className="fw-medium ms-text-secondary">Monthly Interest Rate</p>
                        </div>
                        ...
                        <div className="col-md-6 col-lg-4 py-3 border-bottom">
                            ...
                            <p className="fw-medium ms-text-secondary">Offered Annual Percentage Rate (APR)</p>
                        </div>

                        <div className="col-md-6 col-lg-4 py-3 border-end">
                            <h3 className="fw-bold">18%</h3>
                            <p className="fw-medium ms-text-secondary">GST on Processing Fee</p>
                        </div>

                        <div className="col-md-6 col-lg-4 py-3 border-end">
                            <h3 className="fw-bold">1 – 3 Years</h3>
                            <p className="fw-medium ms-text-secondary">Tenure / Repayment Period</p>
                        </div>
            ...
            <section className="py-3">
                <div className="container">
                    ...
                    <p className="text-muted small mt-3">
                        *The above example is for representative purposes only and actual loan
                        terms may vary.
                    </p>
            ...
            <section className='py-2 pb-5'>
                <div className='container'>
                    ...
                    <p className="small mt-1">
                        We are registered under the name <span className='fw-semibold'>SUBURBAN FINANCE & INVESTMENT PRIVATE LIMITED,</span> a registered NBFC (non-banking financial institution), approved by RBI.
                    </p>
                </div>
            </section>
